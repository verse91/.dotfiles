...
if node_modules_root and project_root then
  ...
  -- Check if analog-language-server is available
  local function has_analog_server()
    return vim.fn.executable("analog-language-server") == 1
  end

  if not configs.analog and has_analog_server() then
    configs.analog = {
      default_config = {
        cmd = {
...
return {
  {
    ...
    opts = {
      ...
      servers = {
        ...
        volar = {},
        -- analog = {}, -- Disabled: analog-language-server not available
        tailwindcss = {},
        svelte = {},
        glsl_analyzer = {},
      ...
      setup = {
        ...
        -- analog = function(_, opts) end, -- Disabled: analog-language-server not available
