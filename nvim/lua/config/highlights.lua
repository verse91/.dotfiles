...
function M.setup()
  ...
  vim.defer_fn(function()
    ...
    vim.api.nvim_set_hl(0, "BlinkCmpMenu", { bg = "#15141b", fg = "#edecee" })
    vim.api.nvim_set_hl(0, "BlinkCmpMenuBorder", { bg = "#15141b", fg = "#a277ff" })
    vim.api.nvim_set_hl(0, "BlinkCmpMenuSelection", { bg = "#3d375e", fg = "#edecee", bold = true })
    
    -- Documentation window
    vim.api.nvim_set_hl(0, "BlinkCmpDoc", { bg = "#15141b", fg = "#edecee" })
    vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", { bg = "#15141b", fg = "#61ffca" })
    
    -- Signature help
    vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelp", { bg = "#15141b", fg = "#edecee" })
    vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpBorder", { bg = "#15141b", fg = "#ffca85" })
    ...
    vim.api.nvim_set_hl(0, "Pmenu", { bg = "#15141b", fg = "#edecee" })
    ...
    -- Float border color
    vim.api.nvim_set_hl(0, "FloatBorder", { bg = "#15141b", fg = "#a277ff" })
